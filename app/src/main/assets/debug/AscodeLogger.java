 ...
 *
 * Usage:
 * - Call `AscodeLogger.startLogging()` to begin logging.
 * - Call `AscodeLogger.stopLogging()` to stop logging.
 * - Use `AscodeLogger.broadcastLog(String)` to manually send a debug log message.
 */
public class AscodeLogger {
    ...
    public static void broadcastLog(String log) {
        ...
        intent.setAction("com.ascode.android.ACTION_NEW_DEBUG_LOG");
