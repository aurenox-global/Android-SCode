...
public class yq {
    ...
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/assets
     */
    public final String assetsPath;

    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/assets/fonts
     */
    public final String fontsPath;

    /**
     * Path of ZIP file containing compiled resources of the current project,
     * e.g. /storage/emulated/0/.AndroidSCode/mysc/605/bin/InternalDemo.apk.res
     */
    public final String resourcesApkPath;

    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin/classes.dex
     */
    public final String classesDexPath;

    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin/InternalDemo.apk.unsigned
     */
    public final String unsignedUnalignedApkPath;

    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin/InternalDemo.apk
     */
    public final String finalToInstallApkPath;

    /**
     * Example content: /storage/emulated/0/ascode/signed_apk/InternalDemo_release.apk
     */
    public final String releaseApkPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin/InternalDemo.apk.unsigned.aligned
     */
    public final String unsignedAlignedApkPath;
    public final String sc_id;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/
     */
     ...
     * e.g. /storage/emulated/0/.AndroidSCode/mysc/605/bin/aapt_rules.pro
     */
    ...
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/AndroidManifest.xml
     */
    public final String androidManifestPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main
     */
    public final String generatedFilesPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin
     */
    public final String binDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/bin/classes
     */
    public final String compiledClassesPath;
    /**
     * Project's generated R.java files directory,
     * e.g. /storage/emulated/0/.AndroidSCode/mysc/605/gen
     */
    public final String rJavaDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/res
     */
    public final String resDirectoryPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/proguard-rules.pro
     */
    public final String proguardFilePath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/res/layout
     */
    public final String layoutFilesPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/java
     */
    public final String javaFilesPath;
    /**
     * Example content: /storage/emulated/0/.AndroidSCode/mysc/605/app/src/main/res/raw
     */
    ...
    /**
     * Prepares to compile and creates /Internal storage/.AndroidSCode/mysc/&lt;sc_id&gt;/ directories,
    ...
    /**
     * Generates DebugActivity.java, AscodeApplication.java, and AscodeLogger.java, if necessary.
     */
    public void generateDebugFiles(Context context) {
        ...
        String javaDir = FileUtil.getExternalStorageDir() + "/.AndroidSCode/data/" + sc_id + "/files/java/";
        ...
        String customApplicationClassName = new ProjectSettings(sc_id).getValue(
                ProjectSettings.SETTING_APPLICATION_CLASS, ".AscodeApplication");
        boolean notUsingCustomApplicationClass = customApplicationClassName.equals(".AscodeApplication");

        if (!customApplicationClassName.startsWith(".")) {
            customApplicationClassName = "." + customApplicationClassName; // since ascode don't allow creating any java file outside the package name
        }
        ...
        if (!targetApplicationFile.exists()) {
            ...
            String sketchApplicationFileContent = fileUtil.b(
                    context,
                    "debug" + File.separator + "AscodeApplication.java"
            );
            ...
            if (logcatEnabled) {
                sketchApplicationFileContent = sketchApplicationFileContent.replace(
                                "super.onCreate();", "AscodeLogger.startLogging();\n        super.onCreate();")
                        .replace("Process.killProcess(Process.myPid());",
                                "AscodeLogger.broadcastLog(Log.getStackTraceString(throwable));\n" +
        ...
        if (logcatEnabled) {
            File sketchLoggerFile = new File(javaDir, "AscodeLogger.java");
            if (!sketchLoggerFile.exists()) {
                String sketchLoggerFileContent = fileUtil.b(
                        context,
                        "debug" + File.separator + "AscodeLogger.java"
                );
                ...
                fileUtil.b(javaFilesPath + File.separator + packageNameAsFolders + File.separator + "AscodeLogger.java",
    ...
    public ArrayList<SrcCodeBean> a(hC projectFileManager, eC projectDataManager, BuiltInLibraryManager builtInLibraryManager) {
        generateDebugFiles(AscodeApplication.getContext());
        CommandBlock.x();

        String javaDir = FileUtil.getExternalStorageDir() + "/.AndroidSCode/data/" + sc_id + "/files/java/";
        String layoutDir = FileUtil.getExternalStorageDir() + "/.AndroidSCode/data/" + sc_id + "/files/resource/layout/";
        List<File> javaFiles;
        {
        ...
        // at /Internal storage/.AndroidSCode/data/<sc_id>/files/java/
        ...
        if (newXMLCommand && FileUtil.isExistFile(path)) {
            FileUtil.copyFile(path, FileUtil.getExternalStorageDir().concat("/.AndroidSCode/temp/commands"));
        }
        ...
        // at /Internal storage/.AndroidSCode/data/<sc_id>/files/resource/layout/
        ...
        if (!javaFiles.contains(new File(javaDir + "AscodeUtil.java"))) {
            srcCodeBeans.add(new SrcCodeBean("AscodeUtil.java",
