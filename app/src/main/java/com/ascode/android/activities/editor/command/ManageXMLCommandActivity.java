package com.ascode.android.activities.editor.command;
...
import com.ascode.android.activities.editor.command.adapters.XMLCommandAdapter;
import com.ascode.android.databinding.ManageXmlCommandAddBinding;
import com.ascode.android.databinding.ManageXmlCommandBinding;
        ...
        binding.positive.setOnClickListener(
                v -> {
                    ...
                    if (TextUtils.isEmpty(xmlName)) {
                        AscodeUtil.toastError("XML name is required");
                        return;
                    }
                    if (TextUtils.isEmpty(reference)) {
                        AscodeUtil.toastError("reference is required");
                        return;
                    }
    ...
    private void fetchCommand() {
        if (FileUtil.isExistFile(commandPath)) {
            try {
                ...
                android.util.Log.d("Ascode", "ManageXMLCommandActivity: Exception ignored", ignored);
            }
        }
    }
