...
import com.ascode.android.activities.main.fragments.projects_store.adapters.ProjectScreenshotsAdapter;
import com.ascode.android.activities.main.fragments.projects_store.api.ProjectModel;
import com.ascode.android.databinding.FragmentStoreProjectPreviewBinding;
...
public class ProjectPreviewActivity extends BaseAppCompatActivity {
    ...
    private void loadProjectData(Bundle bundle) {
        ...
        binding.btnDownload.setOnClickListener(v -> AscodeUtil.toastError("Downloading projects is unavailable right now!"));
    ...
    private void addChip(String name) {
        ...
        params.setMarginEnd(AscodeUtil.dpToPx(12f));
