package com.ascode.android.activities.preview;
...
import a.a.a.wq;
import a.a.a.yq;
import com.ascode.android.databinding.ActivityLayoutPreviewBinding;
import com.ascode.android.tools.ViewBeanParser;
...
public class LayoutPreviewActivity extends BaseAppCompatActivity {
     ...
     * "sin constructor usable..." etc. Lo pone {@link com.ascode.android.utility.InvokeUtil}. Sirve para
     ...
     * leer {@code .ascode/...}. Sin el, {@code @color/}, {@code @drawable/}, {@code styles.xml} y
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (scId == null || title == null) {
            AscodeUtil.toastError("Missing preview data.");
            finish();
            return;
        }
        ...
        try {
            ...
            AscodeUtil.showAnErrorOccurredDialog(this, "No se pudo preparar la vista previa: " + throwable);
        }
    ...
    public void onResume() {
        ...
        if (storageOk != lastStorageOk) {
            ...
            android.util.Log.i(TAG, "info: permiso de almacenamiento " + (storageOk ? "concedido" : "retirado")
                    + ": se releen los recursos del proyecto (.ascode) en la siguiente previsualizacion");
        }
    ...
    private void renderCurrentLayout() {
        ...
        new Thread(() -> {
            try {
                ...
                runOnUiThread(() -> {
                    rendering = false;
                    AscodeUtil.toastError("Preview failed: " + throwable.getMessage());
                });
            }
    ...
    private void refreshFromProject() {
        ...
        new Thread(() -> {
            try {
                ...
                android.util.Log.d("Ascode", "LayoutPreviewActivity: Exception ignored", ignored);
            }
    ...
    private void renderLayout(String layoutName, String xml) {
        ...
        if (!tryInflateRealLayout(layoutName, xml) && !renderWithViewPane(layoutName, xml)) {
            ...
            AscodeUtil.toastError("No se pudo generar la vista previa de este layout");
        }
    }
    ...
    private String buildPreviewWarningReport(boolean truncate) {
        ...
        if (!legacy.isEmpty()) {
            text.append("\n\nLos nombres heredados de arriba SI se han dibujado, usando el icono actual")
                    .append(" del editor (la version vieja de Android SCode los llamaba de otra forma).");
        }
        text.append("\n\n— Android SCode · vista previa de disenos");
    ...
    private void copyPreviewReport(String report) {
        try {
            ...
            if (clipboard == null) {
                AscodeUtil.toastError("No se pudo copiar el aviso");
                return;
            }
            clipboard.setPrimaryClip(ClipData.newPlainText("Vista previa", report));
            AscodeUtil.toast("Aviso copiado");
     ...
     * ({@code .ascode/...}). En Android 11+ hace falta el permiso especial "Acceso a todos los
    ...
    private void maybeAskForStoragePermission() {
        ...
        new com.google.android.material.dialog.MaterialAlertDialogBuilder(this)
                ...
                .setMessage("Sin el permiso \"Acceso a todos los archivos\" la vista previa no puede leer "
                        + "los recursos del proyecto (.ascode): los colores, los iconos, los estilos y "
    ...
    private View createRealView(ViewBean bean, Context parentContext) {
        ...
        com.ascode.android.utility.InvokeUtil.CreateResult result =
                com.ascode.android.utility.InvokeUtil.createViewDetailed(viewContext, className);
    ...
    private ResolvedTheme resolveViewTheme(ViewBean bean, Context baseContext) {
        ...
        for (android.util.Pair<String, String> pair
                : new com.ascode.android.utility.InjectAttributeHandler(bean).getAttributes()) {
    ...
    private View createHorizontalProgressBarIfNeeded(ViewBean bean, View progressBar, Context context) {
        var handler = new com.ascode.android.utility.InjectAttributeHandler(bean);
     ...
     *
     * Importante: {@link com.ascode.android.utility.InjectAttributeHandler} parsea el XML con los
    ...
    private void applyTextTypeface(android.widget.TextView textView, ViewBean bean) {
        ...
        String family = null;
        for (android.util.Pair<String, String> pair : new com.ascode.android.utility.InjectAttributeHandler(bean).getAttributes()) {
    ...
    private android.graphics.Typeface resolveTypeface(String family) {
        ...
        try {
            ...
            android.util.Log.d("Ascode", "LayoutPreviewActivity: familia no valida " + value, ignored);
            return null;
        }
    }
     ...
     *       ({@link com.ascode.android.utility.WidgetInjectApplier}: TabLayout, CircleImageView,
    ...
    private void applyInjectAttributes(View view, ViewBean bean) {
        ...
        try {
            var injectHandler = new com.ascode.android.utility.InjectAttributeHandler(bean);
    ...
    private com.ascode.android.utility.WidgetInjectApplier.ValueResolver sharedResolver(View view) {
        return new com.ascode.android.utility.WidgetInjectApplier.ValueResolver() {
            @Override
     ...
     * (ver {@link com.ascode.android.utility.WidgetInjectApplier}). Los nombres aplicados se anotan en
    ...
    private void applyFamilyAttributes(View view, ViewBean bean,
                                       com.ascode.android.utility.InjectAttributeHandler handler,
        ...
        if (view instanceof com.google.android.material.tabs.TabLayout tabLayout) {
            ...
            com.ascode.android.utility.WidgetInjectApplier.applyTabLayout(tabLayout, handler, resolver);
        ...
        if (view instanceof de.hdodenhof.circleimageview.CircleImageView circleImageView) {
            com.ascode.android.utility.WidgetInjectApplier.applyCircleImageView(circleImageView, handler, resolver);
        ...
        if (view instanceof com.google.android.material.button.MaterialButton materialButton) {
            com.ascode.android.utility.WidgetInjectApplier.applyMaterialButton(materialButton, handler, resolver);
            handled.addAll(MATERIAL_BUTTON_ATTRIBUTES);
        }
        if (view instanceof androidx.cardview.widget.CardView cardView) {
            com.ascode.android.utility.WidgetInjectApplier.applyCardView(cardView, handler, resolver, 0);
    ...
    private void applyProgressBarAttributes(android.widget.ProgressBar progressBar, ViewBean bean,
            com.ascode.android.utility.InjectAttributeHandler handler,
            com.ascode.android.utility.WidgetInjectApplier.ValueResolver resolver,
            java.util.Set<String> handled) {
    ...
    private void applySignInButtonAttributes(com.google.android.gms.common.SignInButton button,
            com.ascode.android.utility.InjectAttributeHandler handler, java.util.Set<String> handled) {
        String size = handler.getAttributeValueOf("buttonSize");
        if (!size.isEmpty()) {
            switch (size) {
    ...
    private String applyGenericAttribute(View view, String name, String value) {
        try {
            switch (name) {
                ...
                case "background": {
                    if (com.ascode.android.activities.preview.ProjectResourceResolver.isStyleReference(value)) {
                ...
                case "actionBarPopupTheme": {
                    ...
                    com.ascode.android.activities.preview.ProjectResourceResolver.StyleResolution resolution =
                            resourceResolver.resolveStyle(value, name);
                    if (resolution != null && resolution.isUsable()) {
     ...
     * diseno ({@link com.ascode.android.utility.WidgetInjectApplier#applyCardView}) para que las dos
    ...
    private void applyCardViewInject(androidx.cardview.widget.CardView cardView, ViewBean bean) {
        ...
        com.ascode.android.utility.WidgetInjectApplier.applyCardView(
    ...
    private String collectJavaSource(String layoutName) {
        ...
        try {
            ...
            android.util.Log.d("Ascode", "LayoutPreviewActivity: Throwable ignored", ignored);
        }
