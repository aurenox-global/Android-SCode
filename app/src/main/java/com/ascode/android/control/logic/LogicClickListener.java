package com.ascode.android.control.logic;

import static android.text.TextUtils.isEmpty;
import static com.ascode.android.AscodeApplication.getContext;
...
import com.ascode.android.databinding.AddCustomListBinding;
import com.ascode.android.databinding.AddCustomVariableBinding;
import com.ascode.android.lib.validator.VariableModifierValidator;
import com.ascode.android.lib.validator.VariableTypeValidator;
...
public class LogicClickListener implements View.OnClickListener {
    ...
    private void removeVariable() {
        ...
        int horizontalPadding = AscodeUtil.dpToPx(20f);
        RecyclerView recyclerView = new RecyclerView(logicEditor);
        recyclerView.setPadding(horizontalPadding, AscodeUtil.dpToPx(8f), horizontalPadding, 0);
                ...
                checkBoxHolder.checkBox.setOnClickListener(v -> {
                    ...
                    if (item.type == Item.TYPE_ITEM && isChecked) {
                        if (isInUseChecker.apply(item.text)) {
                            ...
                            AscodeUtil.toastError(Helper.getResString(item.inUseMessage), bB.TOAST_WARNING);
