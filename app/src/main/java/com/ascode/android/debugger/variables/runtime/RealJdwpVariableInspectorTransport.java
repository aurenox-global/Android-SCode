package com.ascode.android.debugger.variables.runtime;
...
import com.ascode.android.debugger.variables.JdwpVariableInspectRequest;
import com.ascode.android.debugger.variables.JdwpVariableInspectResult;
import com.ascode.android.debugger.variables.JdwpVariableInspectorTransport;
import com.ascode.android.debugger.variables.JdwpVariableNode;
import com.ascode.android.debugger.variables.JdwpVariableScope;
import com.ascode.android.debugger.variables.JdwpVariableValue;
...
public final class RealJdwpVariableInspectorTransport implements JdwpVariableInspectorTransport {
    ...
    public JdwpVariableInspectResult inspect(JdwpVariableInspectRequest request) {
        ...
        try {
            ...
            android.util.Log.d("Ascode", "RealJdwpVariableInspectorTransport: SecurityException ignored", ignored);
        }
        variables.add(new JdwpVariableNode(
                "runtime.env.count",
                "",
