...
import com.ascode.android.flutter.FlutterToolchainPaths.RemoteArtifact
import java.io.File
...
object FlutterPackagingSupport {
     ...
     * **dato del proyecto** (`.ascode/data/<sc_id>/proguard-rules.pro`), no un fichero del repo.
     */
    @JvmStatic
    fun appendFlutterKeepRules(proguardRulesFile: File): Boolean {
        val marker = "# --- Flutter (ascode-pro, carril C) ---"
        val rules = """
            $marker
