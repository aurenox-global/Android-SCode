...
/**
 * Defaults y normalización del modelo Flutter (analogo a [com.ascode.android.kmp.KmpProjectDefaults]).
 */
object FlutterProjectDefaults {

    const val DEFAULT_PROJECT_NAME: String = "FlutterProject"
    const val DEFAULT_PACKAGE_NAME: String = "com.ascode.android.flutter"
