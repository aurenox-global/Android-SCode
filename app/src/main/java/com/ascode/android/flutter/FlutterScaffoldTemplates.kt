package com.ascode.android.flutter
...
object FlutterScaffoldTemplates {
    ...
    fun pubspecYaml(projectName: String): String {
        ...
        return """
            # Pubspec generado por Android-SCode (soporte Flutter experimental).
            #
    ...
    fun mainDart(): String {
        return """
            // Aplicacion Flutter minima generada por Android-SCode.
            // Material 3 + contador. Todo el texto esta en espanol.
            import 'package:flutter/material.dart';

            void main() {
              runApp(const AplicacionAndroid SCode());
            }

            class AplicacionAndroid SCode extends StatelessWidget {
              const AplicacionAndroid SCode({super.key});
    ...
    fun androidManifest(packageName: String, projectName: String): String {
        ...
        return """
            ...
            <!-- Plantilla de referencia generada por Android-SCode (no se compila por si sola). -->
    ...
    fun gradleProperties(): String {
        return """
            # Plantilla de referencia generada por Android-SCode (soporte Flutter experimental).
