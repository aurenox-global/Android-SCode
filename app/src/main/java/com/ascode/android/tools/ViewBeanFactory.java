package com.ascode.android.tools;

import static com.ascode.android.utility.PropertiesUtil.parseReferName;
...
import com.ascode.android.utility.AttributeConstants;
...
public class ViewBeanFactory {
    ...
    private void normalizeCircleImageViewScaleType(ImageBean image) {
        ...
        if (!adjusted.equals(image.scaleType)) {
            android.util.Log.w("Ascode", "warning: CircleImageView " + bean.id + ": scaleType "
        ...
        if (value != null) {
            ...
            if (size != null) {
                try {
                    ...
                    android.util.Log.d("Ascode", "ViewBeanFactory: NumberFormatException ignored", ignored);
                }
            }
            injectAttributes.put(attributeName, value);
        }
