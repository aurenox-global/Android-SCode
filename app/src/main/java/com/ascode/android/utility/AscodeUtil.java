...
public class AscodeUtil {
    ...
    /**
     * Show a Toast styled Android SCode-like.
     *
    ...
    public static void toast(String message, int length) {
        try {
            ...
            LogUtil.e("AscodeUtil", "Failed to toast regular message, " + "Toast's message was: \"" + message + "\"", e);
        }
    }

    /**
     * Show a Toast styled Android SCode-like and with length {@link Toast#LENGTH_SHORT}.
     *
     * @param message The message to toast
     */
    ...
    /**
     * Show an error Toast styled Android SCode-like and with length {@link Toast#LENGTH_SHORT}.
     *
     * @param message The message to toast
     * @param length  The toast's length, either {@link Toast#LENGTH_SHORT} or {@link Toast#LENGTH_LONG}
     */
    ...
    public static Optional<String> doSingleStringContentQuery(Uri uri, String columnName) {
        try (Cursor cursor = getContext().getContentResolver().query(uri, new String[]{columnName}, null, null, null)) {
            ...
            LogUtil.e("AscodeUtil", "Failed to do single string content query for Uri " + uri + " and column name " + columnName, e);
            return Optional.empty();
        }
    }
