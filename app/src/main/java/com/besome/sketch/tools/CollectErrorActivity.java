    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            var dialog = new MaterialAlertDialogBuilder(this)
                    ...
                    .setMessage("An error occurred while running Android SCode. " +
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(v -> {
                ...
                String deviceInfo = "Android SCode " + info.versionName + " (" + info.versionCode + ")\n"
                ...
                runOnUiThread(() -> AscodeUtil.toast("Copied", Toast.LENGTH_LONG));
            });
        }
    }
}
