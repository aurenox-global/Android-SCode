...
public class ManageLocalLibrary {
    ...
    public ManageLocalLibrary(String sc_id) {
        ...
        if (FileUtil.isExistFile(localLibraryConfigPath)) {
            ...
            AscodeUtil.toastError("Invalid Local library configuration found! Temporarily using none");
        }
        list = new ArrayList<>();
    }
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (localLibrary.containsKey("assetsPath")) {
                ...
                if (assetsPath instanceof String) {
                    ...
                    AscodeUtil.toastError("Invalid assets path of enabled Local library #" + i, Toast.LENGTH_LONG);
                }
            }
        }
    ...
    public ArrayList<String> getDexLocalLibrary() {
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (dexPath instanceof String) {
                ...
                AscodeUtil.toastError("Invalid DEX path of enabled Local library #" + i, Toast.LENGTH_LONG);
            }
        }
        ...
        for (String packageName : getPackageNames()) {
            if (!packageName.isEmpty()) {
                File projectGenFolder = new File(Environment.getExternalStorageDirectory(),
                        ".AndroidSCode/mysc/".concat(projectId).concat("/gen"));
    ...
    public ArrayList<File> getLocalLibraryJars() {
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (jarPath instanceof String) {
                ...
                AscodeUtil.toastError("Invalid JAR path of enabled Local library #" + i + "->" + localLibrary.get("name"), Toast.LENGTH_LONG);
            }
        }
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (localLibrary.containsKey("packageName")) {
                ...
                if (packageName instanceof String) {
                    ...
                    AscodeUtil.toastError("Invalid package name of enabled Local library #" + i, Toast.LENGTH_LONG);
                }
            }
        }
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (localLibrary.containsKey("pgRulesPath")) {
                ...
                if (proguardRulesPath instanceof String) {
                    ...
                    AscodeUtil.toastError("Invalid ProGuard path of enabled Local library #" + i, Toast.LENGTH_LONG);
                }
            }
        }
        ...
        for (int i = 0, listSize = list.size(); i < listSize; i++) {
            ...
            if (localLibrary.containsKey("resPath")) {
                ...
                if (resPath instanceof String) {
                    ...
                    AscodeUtil.toastError("Invalid res/ folder path of enabled Local library #" + i, Toast.LENGTH_LONG);
                }
            }
        }
