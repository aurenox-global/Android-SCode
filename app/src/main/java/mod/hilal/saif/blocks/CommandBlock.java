...
public class CommandBlock {
    ...
    public static String applyCommands(String fileName, String c) {
        String str = c;
        String path = FileUtil.getExternalStorageDir().concat("/.AndroidSCode/temp/commands");
    ...
    private static void writeLog(String s) {
        String path = FileUtil.getExternalStorageDir().concat("/.AndroidSCode/temp/log.txt");
        String text = "";
        if (FileUtil.isExistFile(path)) {
