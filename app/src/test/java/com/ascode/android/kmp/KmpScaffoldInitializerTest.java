...
public class KmpScaffoldInitializerTest {
    ...
    public void initialize_createsExpectedFiles() throws Exception {
        ...
        assertTrue(new File(tempDir, "androidApp/src/main/kotlin/pro/ascode/demo/android/MainActivity.kt").exists());
        assertTrue(new File(tempDir, "desktopApp/src/main/kotlin/pro/ascode/demo/desktop/Main.kt").exists());
        assertTrue(new File(tempDir, "shared/src/commonMain/kotlin/pro/ascode/demo/Platform.kt").exists());
        assertTrue(new File(tempDir, "shared/src/commonMain/kotlin/pro/ascode/demo/GeneratedPlatformBindings.kt").exists());
        assertTrue(new File(tempDir, "shared/src/androidMain/kotlin/pro/ascode/demo/GeneratedPlatformBindings.kt").exists());
        assertTrue(new File(tempDir, "shared/src/desktopMain/kotlin/pro/ascode/demo/GeneratedPlatformBindings.kt").exists());

        String platformContent = new String(
            Files.readAllBytes(new File(tempDir, "shared/src/commonMain/kotlin/pro/ascode/demo/Platform.kt").toPath()),
            StandardCharsets.UTF_8
        );
        String commonBindingsContent = new String(
            Files.readAllBytes(new File(tempDir, "shared/src/commonMain/kotlin/pro/ascode/demo/GeneratedPlatformBindings.kt").toPath()),
            StandardCharsets.UTF_8
        );
        String desktopMainContent = new String(
            Files.readAllBytes(new File(tempDir, "desktopApp/src/main/kotlin/pro/ascode/demo/desktop/Main.kt").toPath()),
            StandardCharsets.UTF_8
        );
